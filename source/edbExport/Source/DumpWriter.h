#ifndef _DUMPWRITER_H__INCLUDED_
#define _DUMPWRITER_H__INCLUDED_
...
class CDumpWriter : public IWriter
{
public:
    CDumpWriter() : m_currFile(NULL), m_timeHeader(false) { m_printBuf.reserve(8192); }
    virtual ~CDumpWriter();
...
private:
    ...
    P2ERR WriteBuffer(const char * pBuf, size_t bufferLen, bool bEvent);
    P2ERR CheckFile();
    P2ERR CloseCurrentFile();
};

#endif // _DUMPWRITER_H__INCLUDED_
