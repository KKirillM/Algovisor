...
#define PSC_ELM_PACKET_TYPE_INITIALIZE			0
#define PSC_ELM_PACKET_TYPE_MESSAGE				1
#define PSC_ELM_PACKET_TYPE_WARNING				2
#define PSC_ELM_PACKET_TYPE_ERROR				3
#define PSC_ELM_PACKET_TYPE_LICENSE_EXPIRED		4
...
//	 other value - failure, IAT is modified
