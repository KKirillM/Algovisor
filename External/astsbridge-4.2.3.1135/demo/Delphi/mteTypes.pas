...
type
  TTEFieldType = (ftChar, ftInteger, ftFixed, ftFloat, ftDate, ftTime,
    ftFloatPoint{MTEStuctureEx(Version >= 3});
...
const
  ...
  // MTEStructureEx versions
  STRUCTURE_VERSION_0 = 0;
  STRUCTURE_VERSION_1 = 1;
  STRUCTURE_VERSION_2 = 2;
  STRUCTURE_VERSION_3 = 3;
  
  // MTEStructureEx options
  STRUCTURE_VERSION_MASK = $00FF;
  STRUCTURE_OPTIONS_MASK = $FF00;
  STRUCTURE_LOCALIZATION = $0100; // get localized versions for captions and descriptions
